...
// ELIMINADO: import compression from 'express-compression';
...
// ============================================
// COMPRESIÓN NATIVA (SIN DEPENDENCIAS EXTERNAS)
// ============================================
// Usamos el middleware de compresión de Express
app.use((req, res, next) => {
    // Verificar si el cliente acepta compresión gzip
    const acceptEncoding = req.headers['accept-encoding'] || '';
    if (acceptEncoding.includes('gzip')) {
        // Express maneja esto automáticamente con res.send, res.json, etc.
        // Solo necesitamos asegurar que los archivos estáticos se sirvan comprimidos
        next();
    } else {
        next();
    }
