...
// Redireccionar /admin.html a /admin
...
app.use((req, res) => {
    ...
    // Para rutas no API, devolver página 404 HTML
    res.status(404).send(`
        <!DOCTYPE html>
        <html>
        <head>
...
app.use((err, req, res, next) => {
    ...
    // Para rutas no API, devolver HTML
    res.status(500).send(`
        <!DOCTYPE html>
        <html>
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Error - Tienda La Reina</title>
            <style>
                body {
                    font-family: 'Inter', system-ui, sans-serif;
                    display: flex;
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`📋 Panel Admin: ${process.env.URL || 'https://tienda-fg.onrender.com'}/admin`);
